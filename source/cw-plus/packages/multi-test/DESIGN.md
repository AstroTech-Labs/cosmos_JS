...
Inside App, it maintains the root `Storage`, and the `BlockInfo` for the current
...
Since much of the logic, both on the app side, as well as in submessages, relies
