...
Pull requests are merged automatically using
...
- Missing 3 scheduled meetings results in ICF evaluating whether the member
...
In absence of general consensus, decision making requires 1/2 vote from the two
