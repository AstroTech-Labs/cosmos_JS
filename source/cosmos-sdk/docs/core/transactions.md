...
As a developer, you should rarely manipulate `Tx` directly, as `Tx` is really an
...
As there are currently two sign modes for signing transactions, there are also
