...
The channel closing handshake will also invoke module callbacks that can return
...
Since the version type is a string, applications have the ability to do simple
