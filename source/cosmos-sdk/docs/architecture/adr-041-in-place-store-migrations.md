...
This methods returns an `uint64` which serves as state-breaking version of the
...
If a required migration is missing (e.g. if it has not been registered in the
