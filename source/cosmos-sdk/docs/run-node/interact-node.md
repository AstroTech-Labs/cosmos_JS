...
You should see two delegations, the first one made from the `gentx`, and the
...
The list of all available gRPC query endpoints is
...
As described in the [gRPC guide](../core/grpc_rest.md), all gRPC services on the
