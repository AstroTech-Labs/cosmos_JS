...
The `AppModuleBasic` interface defines the independent methods modules need to
implement.
...
Typically, the various application module interfaces are implemented in a file
