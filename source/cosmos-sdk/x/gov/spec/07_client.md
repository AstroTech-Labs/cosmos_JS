...
The `deposit` command allows users to query a deposit for a given proposal from
a given depositor.
...
The `param` command allows users to query a given parameter for the `gov`
module.
...
The `proposals` command allows users to query all proposals with optional
filters.
...
The `submit-proposal` command allows users to submit a governance proposal and
to optionally include an initial deposit.
...
The `vote` command allows users to submit a vote for a given governance
proposal.
...
The `weighted-vote` command allows users to submit a weighted vote for a given
governance proposal.
...
The `Proposals` endpoint allows users to query all proposals with optional
filters.
...
The `Deposit` endpoint allows users to query a deposit for a given proposal from
a given depositor.
...
The `proposals` endpoint also allows users to query all proposals with optional
filters.
...
The `deposits` endpoint allows users to query a deposit for a given proposal
