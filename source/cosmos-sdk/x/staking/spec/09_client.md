...
The `delegation` command allows users to query delegations for an individual
...
The `delegations` command allows users to query delegations for an individual
delegator on all validators.
...
The `delegations-to` command allows users to query delegations on an individual
validator.
...
The `historical-info` command allows users to query historical information at
given height.
...
The `pool` command allows users to query values for amounts stored in the
staking pool.
...
The `redelegation` command allows users to query a redelegation record based on
delegator and a source and destination validator address.
...
The `redelegations` command allows users to query all redelegation records for
an individual delegator.
...
The `redelegations-from` command allows users to query delegations that are
redelegating _from_ a validator.
...
The `unbonding-delegation` command allows users to query unbonding delegations
...
The `unbonding-delegations` command allows users to query all
...
The `unbonding-delegations-from` command allows users to query delegations that
are unbonding _from_ a validator.
...
The `validator` command allows users to query details about an individual
validator.
...
The `validators` command allows users to query details about all validators on a
network.
...
The command `create-validator` allows users to create new validator initialized
...
The command `redelegate` allows users to redelegate illiquid tokens from one
...
The `Validator` endpoint queries validator information for given validator
address.
...
The `ValidatorDelegations` endpoint queries delegate information for given
validator.
...
The `ValidatorUnbondingDelegations` endpoint queries delegate information for
given validator.
...
The `Delegation` endpoint queries delegate information for given validator
delegator pair.
...
The `UnbondingDelegation` endpoint queries unbonding information for given
validator delegator.
...
The `DelegatorDelegations` endpoint queries all delegations of a given delegator
address.
...
The `DelegatorUnbondingDelegations` endpoint queries all unbonding delegations
...
The `DelegatorValidators` endpoint queries all validators information for given
delegator.
...
The `DelegatorValidator` endpoint queries validator information for given
delegator validator
...
The `DelegatorUnbondingDelegations` REST endpoint queries all unbonding
...
The `DelegatorValidators` REST endpoint queries all validators information for
...
The `DelegatorValidator` REST endpoint queries validator information for given
...
The `HistoricalInfo` REST endpoint queries the historical information for given
height.
...
The `Validators` REST endpoint queries all validators that match the given
status.
...
The `Validator` REST endpoint queries validator information for given validator
address.
...
The `ValidatorDelegations` REST endpoint queries delegate information for given
validator.
...
The `Delegation` REST endpoint queries delegate information for given validator
delegator pair.
...
The `UnbondingDelegation` REST endpoint queries unbonding information for given
validator delegator pair.
...
The `ValidatorUnbondingDelegations` REST endpoint queries unbonding delegations
of a validator.
