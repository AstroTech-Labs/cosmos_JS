...
var plugin = function plugin(builder, bundler) {
  var _builder$options, _builder$options$rpcC;
...
var makeRPC = function makeRPC(builder, bundler, rpc) {
  ...
  var rpcast = (0, _ast.createScopedRpcFactory)(obj, methodName, 'QueryClientImpl' // make option later
  );
  ...
  var importStmts = (0, _imports.getImportStatements)((0, _toConsumableArray2["default"])(fixlocalpaths));
