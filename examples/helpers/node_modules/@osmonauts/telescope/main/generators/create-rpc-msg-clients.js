...
var plugin = function plugin(builder, bundler) {
  ...
  var clients = mutationContexts.map(function (c) {
    ...
    (0, _parse.parse)(ctx);
    var proto = (0, _protoParser.getNestedProto)(c.ref.traversed); // hard-coding, for now, only Msg service
    ...
    var serviceImports = (0, _imports.getDepsFromQueries)(ctx.mutations, localname); // TODO we do NOT need all imports...
