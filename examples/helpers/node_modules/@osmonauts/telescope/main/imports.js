...
exports.getImportsFromQueries = exports.getImportsFromMutations = exports.getImportStatements = exports.getDepsFromQueries = exports.getDepsFromMutations = exports.buildAllImports = exports.aggregateImports = void 0;
...
var buildAllImports = function buildAllImports(context, allImports, filepath) {
  ...
  var importStmts = getImportStatements(imports);
  return importStmts;
};
