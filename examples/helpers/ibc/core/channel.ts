...
export async function query_ibc_core_channel_channels(client: CosmosChainClient, offset?: number,
    ...
    let response = await client.query.ibc.core.channel.v1.channels(
        ibc.core.channel.v1.QueryChannelsRequest.fromPartial({
            pagination: ibc.base.query.v1beta1.PageRequest.fromPartial({offset: offset, limit: limit}),
        }),
    );
    return response;
}
...
export async function query_ibc_core_channel_packetAcknowledgements(client: CosmosChainClient, portId: string, channelId: string, sequence: Long, packetCommitmentSequences: Long[], offset?: number,
                                                                    limit?: number) {
...
export async function query_ibc_core_channel_unreceivedAcks(client: CosmosChainClient, portId: string, channelId: string, packetCommitmentSequences: Long[]) {
